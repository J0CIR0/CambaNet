...
<head>
    ...
    <title>Profesores - <?php echo SITE_NAME; ?></title>
    ...
    <div class="admin-container">
        <div class="admin-sidebar">
            ...
            <ul class="admin-menu">
                ...
                <li><a href="<?php echo url('admin/profesores'); ?>" class="active">Profesores</a></li>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="editarUsuario(<?php echo $profesor['id']; ?>)" class="btn btn-sm">Editar</button>
                                            <button onclick="eliminarUsuario(<?php echo $profesor['id']; ?>)" class="btn btn-sm btn-danger">Eliminar</button>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
